...
[Шуруп](https://t.me/shurup12312)

оригинальная статья: [https://telegra.ph/Svoj-lichnyj-proksi-10-10](https://telegra.ph/Svoj-lichnyj-proksi-10-10)
...
Примечание: **TUN-режим** работает медленнее и может быть большой пинг в играх.
...
domain:domentut.com # так загрузятся все домены, оканчивающиеся на domentut.com
...
В Windows заходите в Параметры > Сеть и Интернет > Прокси-сервер  

Выключаем "Определять параметры автоматически"  
  

Заходим в "Изменить прокси-сервер", IP-адрес и порт у вас должны быть такие же, как на скриншоте (если нет - напишите такие же).
...
26.*;192.*;26.113.138.235

  

Также, вы можете настраивать подобные параметры отдельно в настройках браузера в "Параметрах соединения", или чём-то таком.  
