...
6) Выбираем в этой же менюшке вкладку **Дополнительно** и нажимаем **Импорт JSON** . Туда вставляем этот конфиг из [этого файла](https://github.com/Shurupiii/Shurupi-proxy/blob/main/shurupiconfig.json) .
7) Чтобы добавить какие-либо процессы, домены и т.д. можно этими списками, туда пишете условно 
